...
(function() {
  var abs, atan2, cos, interpolate, mod, sin, sqrt, tau, mathutils;
...
(function() {
  var abs, ciecam, codepoints, disp_CIECAM, gamut, interpolate, mod, polar, pow, rectangular, rgb, sRGB, tau, _ref;
  ...
  gamut.Boundary = function(precision) {
    var circular_distance, decode_pt, distance, edges, encode_pt, horizontal, vertical, vertices;
    if (precision == null) {
      precision = 64;
    }
