...
(function() {
  ...
  gamut.Boundary = function(precision) {
    var circular_distance, decode_pt, distance, encode_pt, horiz_edges, horizontal, vert_edges, vertical, vertices, _ref;
    if (precision == null) {
      precision = 32;
    }
    ...
    vertices = (function() {
      var V, add_vertex, i, j, n, p, s_curve;
      V = {};
      p = precision;
      ...
      add_vertex = function(rgb) {
        var C, J, a_C, b_C, comp, h, point, xyz, _ref, _ref2;
    ...
    _ref = (function() {
      var E_h, E_v, add_edge, add_edges, i, j, lower_vertices, n, p, upper_vertices, v;
      E_h = {};
      E_v = {};
      p = precision;
      ...
      return [E_h, E_v];
    })(), horiz_edges = _ref[0], vert_edges = _ref[1];
    ...
    horizontal = function(J) {
      ...
      output = (function() {
        var _ref, _ref2, _ref3, _ref4, _results;
        _results = [];
        for (edge in horiz_edges) {
          _ref = horiz_edges[edge], v1 = _ref[0], J1 = _ref[1], h1 = _ref[2], v2 = _ref[3], J2 = _ref[4], h2 = _ref[5];
    ...
    vertical = function(h) {
      ...
      output = (function() {
        ...
        for (edge in vert_edges) {
          _ref = vert_edges[edge], v1 = _ref[0], J1 = _ref[1], h1 = _ref[2], v2 = _ref[3], J2 = _ref[4], h2 = _ref[5];
